...
describe('Component Tests', () => {
    ...
    describe('BbHealthCheckComponent', () => {
        ...
        let comp: BbHealthCheckComponent;
        let fixture: ComponentFixture<BbHealthCheckComponent>;
        let service: BbHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [BbTestModule],
                declarations: [BbHealthCheckComponent],
                providers: [
                    BbHealthService,
                    {
                        provide: NgbModal,
        ...
        beforeEach(() => {
            fixture = TestBed.createComponent(BbHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(BbHealthService);
        });
